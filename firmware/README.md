...
## Firmware
We release sources[url] and [binaries]() of the firmware and we try to keep them as synchronized as possible - if you have an mbed, you just need to drop the binary and press the reset button.
